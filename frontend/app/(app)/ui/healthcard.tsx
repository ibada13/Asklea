        ...
        <div className="flex justify-around h-1/3 gap-x-2 ">
            <div className="h-full flex flex-grow flex-col justify-between border rounded-md p-2 bg-[#E0F3FA]">
                ...
                <div>
                    ...
                    <p className='text-2xl font-bold'>{diagnosis_history.respiratory_rate_value} bpm</p>
                </div>
                <p className="flex gap-x-1 items-center text-xss text-nowrap">
                    {diagnosis_history.respiratory_rate_levels === "Normal" ? "" : 
                    diagnosis_history.respiratory_rate_levels === "Higher than Average" 
                        ? <IoMdArrowDropup size={20}/> 
                        : <IoMdArrowDropdown size={20}/>}
                    {diagnosis_history.respiratory_rate_levels}
                </p>
            </div>
            <div className="h-full flex flex-grow flex-col justify-between border rounded-md p-2 bg-[#FFE6E9]">
                ...
                <div>
                    ...
                    <p className='text-2xl font-bold'>{diagnosis_history.temperature_value}°F</p>
                </div>
                <p className="flex gap-x-1 items-center text-xss text-nowrap">
                    {diagnosis_history.temperature_levels === "Normal" ? "" : 
                    diagnosis_history.temperature_levels === "Higher than Average" 
                        ? <IoMdArrowDropup size={20}/> 
                        : <IoMdArrowDropdown size={20}/>}
                    {diagnosis_history.temperature_levels}
                </p>
            </div>
            <div className="h-full flex flex-grow flex-col justify-between border rounded-md p-2 bg-[#FFE6F1]">
                ...
                <div>
                    ...
                    <p className='text-2xl font-bold'>{diagnosis_history.heart_rate_value} bpm</p>
                </div>
                <p className="flex gap-x-1 items-center text-xss text-nowrap">
                    {diagnosis_history.heart_rate_levels === "Normal" ? "" : 
                    diagnosis_history.heart_rate_levels === "Higher than Average" 
                        ? <IoMdArrowDropup size={20}/> 
                        : <IoMdArrowDropdown size={20}/>}
                    {diagnosis_history.heart_rate_levels}
                </p>
            </div>
        </div>
    );
