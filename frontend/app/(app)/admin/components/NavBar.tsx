...
export default function NavBar({links}: {links:NavLink[]}) {
  ...
  return (
    <div className="flex justify-center w-full">
      <div className="w-2/3 rounded-full p-4 bg-gray-200 flex justify-around items-center uppercase font-semibold">
          ...
          return (
            <Link
              ...
              className={`transition-colors duration-300 px-6 py-3 rounded-full flex items-center gap-x-4 ${
                active ? "text-white bg-sg" : "text-black hover:text-white"
              }`}
            >
                  {label}
